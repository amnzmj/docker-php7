			...
			if(( isset($this->_req['clave']) && $this->_req['clave'] != "" ) || ( isset($this->_req['nombre']) && $this->_req['nombre'] != "" ) ){
				...
				if( isset($this->_req['clave']) && $this->_req['clave'] != "" ){
					...
					if($identity['idAdministrador']==12){
							...
							{
							$sql.="`v`.`posgrado`='doctorado_en_ciencias_químico_biológicas'".
							" OR `v`.`posgrado`='especialidad_en_inocuidad_de_alimentos'".
							" OR `v`.`posgrado`='maestría_en_ciencias_químico_biológicas'".
							" OR `v`.`posgrado`='maestría_en_ciencia_y_tecnología_de_los_alimentos'".
							" OR `v`.`posgrado`='doctorado_en_ciencias_de_los_alimentos'".
							" OR `v`.`posgrado`='especialidad_en_bioquímica_clínica' ".
							"AND `v`.`clave` LIKE '%". $this->_req['clave'] ."%'";
						}elseif($identity['idAdministrador']==14){
							$sql.=" `v`.`posgrado`='maestría_en_ciencia_y_tecnología_ambiental'".
							" OR `v`.`posgrado`='maestría_en_ciencias_de_la_energía'".
							" OR `v`.`posgrado`='doctorado_en_ciencias_de_la_energía'".
							" OR `v`.`posgrado`='doctorado en ciencia y tecnología químico-ambiental'";							
							}
				...
				if( isset($this->_req['nombre']) && $this->_req['nombre'] != "" ){
					...
					$sql .= "`v`.`posgrado`='$pos' AND `v`.`nombre` LIKE '%". $this->_req['nombre'] ."%'";
                          ...
                          $sql.="";
							...
							$sql.="WHERE `v`.`posgrado`='doctorado_en_ciencias_químico_biológicas'".
							" OR `v`.`posgrado`='especialidad_en_inocuidad_de_alimentos'".
							" OR `v`.`posgrado`='maestría_en_ciencias_químico_biológicas'".
							" OR `v`.`posgrado`='maestría_en_ciencia_y_tecnología_de_los_alimentos'".
							" OR `v`.`posgrado`='doctorado_en_ciencias_de_los_alimentos'".
							...
							$sql.="WHERE `v`.`posgrado`='maestría_en_ciencia_y_tecnología_ambiental'".
							" OR `v`.`posgrado`='maestría_en_ciencias_de_la_energía'".
							" OR `v`.`posgrado`='doctorado_en_ciencias_de_la_energía'".
							" OR `v`.`posgrado`='doctorado en ciencia y tecnología químico-ambiental'";							
							}
